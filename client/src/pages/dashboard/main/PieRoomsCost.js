...
export default function PieRoomsCost() {
  ...
  const [costGroups, setCostGroups] = React.useState([]);
  ...
  useEffect(() => {
    ...
    setCostGroups([
      { name: "Fee Stay", qty: free },
      { name: "Less Than $15", qty: lessThan15 },
      { name: "Between $15 and $15", qty: between15And35 },
  ...
  return (
    ...
    >
      ...
      <Stack gap={2}>
        <Typography variant="h6">Room Cost</Typography>
